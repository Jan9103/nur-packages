...

{
  ...
  nushell-custom = pkgs.callPackage ./pkgs/nushell/custom.nix { };
  nushell-preview = pkgs.callPackage ./pkgs/nushell/preview.nix { };
  nushell-unstable = pkgs.callPackage ./pkgs/nushell/unstable.nix { };
